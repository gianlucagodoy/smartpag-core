...
///
/// A classe [SmartLoggerServicesImpl] implementa a interface [SmartLoggerServices] e fornece
/// serviços de logging para a biblioteca Smart.
///
...
///
/// [SmartLoggerServicesImpl] é responsável por todo o **log** da aplicação.
///
...
class SmartLoggerServicesImpl implements SmartLoggerServices {
  late Logger logger;
  ...
  void log(
    String message, {
    required SmartLogType type,
  }) {
    if (type == SmartLogType.info) {
      info(message);
    } else if (type == SmartLogType.debug) {
      debug(message);
    } else if (type == SmartLogType.warning) {
      warning(message);
    } else if (type == SmartLogType.error) {
      error(message);
    }
  }

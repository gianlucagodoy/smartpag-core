...
import '../../interfaces/services/analytics/zuk_analytics_service.dart';

///
/// A classe [ZukAnalyticsServiceImpl] é responsável por implementar o serviço de analytics do Zuk,
...
///
class ZukAnalyticsServiceImpl implements ZukAnalyticsService {
  ZukAnalyticsServiceImpl() : super();

...
///
/// A classe [ZukCrashlyticsServicesImpl] implementa a interface [ZukCrashlyticsServices]
...
///
class ZukCrashlyticsServicesImpl implements ZukCrashlyticsServices {
  final FirebaseCrashlytics _instance;

  ZukCrashlyticsServicesImpl(this._instance);

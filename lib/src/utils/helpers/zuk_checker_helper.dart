...
class ZukCheckerHelper {
  ...
  static bool validateCpf(String cpf) {
    if (cpf.isNotEmpty &&
        ...
        !ZukBlackList.BLACK_LIST_LENGTH_11.contains(cpf)) {
      int sum = 0;
      int rest;
      for (var i = 1; i <= 9; i += 1) {
  ...
  static bool validateCnpj(String cnpj) {
    if (cnpj.isNotEmpty &&
        ...
        !ZukBlackList.BLACK_LIST_LENGTH_14.contains(cnpj)) return true;
    return false;
  }
  ...
  static bool validatePhone(String phone) {
    if (phone.isNotEmpty &&
        ...
        !ZukBlackList.BLACK_LIST_LENGTH_11.contains(phone) &&
        ZukGlobalConstants.DDD_BRASIL.contains(phone.substring(0, 2)))
      return true;
    return false;
  }

...
///
/// A classe [ZukTextFormatterHelper]  contém métodos utilitários para formatar diferentes tipos de dados, como moeda,
...
class ZukTextFormatterHelper {
  ...
  static String formatDocumentNumber(String input) {
    if (input.length <= 11) {
      return ZukMaskTextInputFormatters.cpfTextFormatter.maskText(input);
    } else {
      return ZukMaskTextInputFormatters.cnpjTextFormatter.maskText(input);
    }
  }
}

...
class SmartHttpHelper {
  static bool isSuccessCode(int? code) =>
      code != null &&
      code >= SmartHttpConstants.HTTP_OK &&
      code <= SmartHttpConstants.HTTP_NO_CONTENT;

  static bool isErrorCode(int? code) =>
      code != null && code >= SmartHttpConstants.HTTP_INTERNAL_SERVER_ERROR;

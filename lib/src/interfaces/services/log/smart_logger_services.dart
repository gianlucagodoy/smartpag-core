...
///
/// A classe [SmartLoggerServices] é uma classe abstrata que define os métodos para registrar logs
/// em diferentes tipos.
///
...
/// especifica o tipo de log, que é do tipo [SmartLogType].
///
...
///
abstract class SmartLoggerServices {
  /// O método [log] é responsável por registrar um log com uma mensagem e um tipo de log específico.
  /// O parâmetro [message] é a mensagem a ser registrada, enquanto o parâmetro [type]
  /// especifica o tipo de log, que é do tipo [SmartLogType].
  void log(
